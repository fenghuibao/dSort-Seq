...
#### 4. Mixing coefficient (.txt, .csv, .xls, .xlsx)

The proportion of each variant in the library, obtained via NGS of the library. For an example, see example/mixing_coefficient.
